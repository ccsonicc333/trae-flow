...
- Flow Island left-region compact feature view and expanded feature container: `TraeFlow/UI/Views/LeftFeatures/MusicCompactView.swift`, `ShelfCompactView.swift`, `MusicExpandedView.swift`, `ShelfExpandedView.swift`, `LeftFeatureContainerView.swift` (resize handles for per-feature expanded size), `LeftFeatureSwitcherBar.swift`
