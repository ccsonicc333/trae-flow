...
BRAND_LOGO_SOURCE="${TRAE_FLOW_DMG_LOGO_SOURCE:-$PROJECT_DIR/docs/images/trae-flow-icon-transparent.svg}"
DMG_BACKGROUND_SOURCE="${TRAE_FLOW_DMG_BACKGROUND_SOURCE:-$PROJECT_DIR/docs/images/trae-flow-dmg-installer-background.png}"
DMG_ICON_SOURCE="${TRAE_FLOW_DMG_ICON_SOURCE:-}"
FALLBACK_ICON_PNG="$PROJECT_DIR/TraeFlow/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png"

VOLNAME=""
SOURCE_DIR=""
OUTPUT_DMG=""
APP_NAME="TRAE FLOW.app"
WINDOW_WIDTH="${TRAE_FLOW_DMG_WINDOW_WIDTH:-768}"
WINDOW_HEIGHT="${TRAE_FLOW_DMG_WINDOW_HEIGHT:-512}"
ICON_SIZE="${TRAE_FLOW_DMG_ICON_SIZE:-108}"
APP_X="${TRAE_FLOW_DMG_APP_X:-212}"
APP_Y="${TRAE_FLOW_DMG_APP_Y:-246}"
APPLICATIONS_X="${TRAE_FLOW_DMG_APPLICATIONS_X:-602}"
APPLICATIONS_Y="${TRAE_FLOW_DMG_APPLICATIONS_Y:-248}"
FAIL_ON_PLAIN="${TRAE_FLOW_DMG_FAIL_ON_PLAIN:-0}"
FINDER_VOLUME_NAME=""
...
Environment:
  TRAE_FLOW_DMG_BACKGROUND_SOURCE  Optional background image override
EOF
}
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/trae-flow-dmg.XXXXXX")"
