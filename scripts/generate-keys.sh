...
POSSIBLE_PATHS=(
    "$HOME/Library/Developer/Xcode/DerivedData/TraeFlow-*/SourcePackages/artifacts/sparkle/Sparkle/bin/generate_keys"
...
echo ""
echo "Your PUBLIC key (add this to Config/LocalSecrets.xcconfig as SPARKLE_PUBLIC_ED_KEY):"
echo ""
echo "  $PUBLIC_KEY"
echo ""
...
echo ""
echo "Next steps:"
echo "1. Copy Config/LocalSecrets.example.xcconfig to Config/LocalSecrets.xcconfig"
echo "2. Set SPARKLE_PUBLIC_ED_KEY to the public key above"
echo "3. Set SPARKLE_APPCAST_URL to your hosted appcast.xml URL"
echo "4. Run ./scripts/build.sh to build a release"
echo "5. Run ./scripts/create-release.sh to create a signed DMG and appcast"
