...
final class SettingsWindowControllerTests: XCTestCase {
    func testFloatingPetGuidanceStringsMentionSecondaryClickToReopenSettings() {
        ...
        XCTAssertTrue(
            english.contains("\"手动打开形态选择引导；选择刘海屏或独立悬浮宠物后，会继续进入 Hooks 演示。\" = \"Manually open the surface selection onboarding. After choosing the top Island or floating pet, TRAE FLOW continues into the Hooks demo.\";")
        )
    }
    ...
    private func localizationFileContents(named localeCode: String) throws -> String {
        ...
        let fileURL = repoRoot
            .appendingPathComponent("TraeFlow")
