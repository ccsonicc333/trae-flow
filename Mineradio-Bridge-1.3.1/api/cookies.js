...
const QQ_DOMAINS = ['y.qq.com', '.y.qq.com', '.qq.com', 'i.y.qq.com', '.tencent.com'];
const QQ_URLS = ['https://y.qq.com/', 'https://y.qq.com', 'https://i.y.qq.com/'];
...
const KG_COOKIE_KEYS = ['userid', 'token', 'KugooID', 'KuGoo', 'Kugoo', 'NickName', 'nickname', 'kg_mid', 'kugouid', 'pic', 'user_pic', 'avatar', 'headpic', 'userpic', 'dfid', 'DFID', 'KToken', 't', 't1', 'KugooPwd', 'vip_type', 'vip_token', 'VIPType', 'VipType', 'musicvip', 'MusicPack', 'musicpack', 'is_vip'];
