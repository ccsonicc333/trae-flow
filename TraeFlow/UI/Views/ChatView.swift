...
struct ChatView: View {
    ...
    /// When an external client is waiting for input, top-align sparse
...
struct UserMessageView: View {
    let text: String
    let onTap: () -> Void
    private let logger = Logger(subsystem: "ai.traeflow.app", category: "ChatTap")
