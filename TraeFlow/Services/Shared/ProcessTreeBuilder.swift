...
struct ProcessTreeBuilder: Sendable {
    ...
    nonisolated static let logger = Logger(subsystem: "ai.traeflow.app", category: "ProcessTree")
    ...
    /// tool process is launched from an intermediate host such as a wrapper process.
