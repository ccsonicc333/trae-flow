...
extension Notification.Name {
    static let traeFlowHookWalkthroughDemoShouldCloseNotch = Notification.Name("traeFlowHookWalkthroughDemoShouldCloseNotch")
}
...
final class HookWalkthroughDemoRunner {
    ...
    func start() {
        let sessionId = "trae-flow-demo-\(UUID().uuidString)"
        ...
        Task {
            ...
            await SessionStore.shared.process(.toolCompleted(
                ...
                result: ToolCompletionResult(
                    status: .success,
                    result: AppLocalization.string("TRAE FLOW 已处理这次演示审批。"),
            ...
            await SessionStore.shared.process(.historyLoaded(
                ...
                conversationInfo: ConversationInfo(
                    ...
                    lastToolName: nil,
                    firstUserMessage: AppLocalization.string("体验一轮 TRAE FLOW Hooks 审批通知流程"),
    ...
    private func closeDockedNotchAfterAnswerIfNeeded() {
        ...
        NotificationCenter.default.post(
            name: .traeFlowHookWalkthroughDemoShouldCloseNotch,
            object: nil
        )
    }
    ...
    private static func questionEvent(
        ...
        let toolInput: [String: AnyCodable] = [
            "questions": AnyCodable([
                [
                    "id": "demo_next_step",
                    "header": "1.",
                    "question": AppLocalization.string("是否批准 TRAE FLOW 继续完成这轮演示？"),
                    "description": AppLocalization.string("选择“批准并继续”，再点击提交，TRAE FLOW 会模拟处理完成并弹出通知。"),
                    "options": [
                        [
                            "id": "approve",
        ...
        return HookEvent(
            ...
            message: AppLocalization.string("TRAE FLOW Demo 正在等待一次演示审批。"),
            bridgeIntervention: SessionIntervention(
                id: toolUseId,
                kind: .question,
                title: AppLocalization.string("TRAE FLOW Demo 的审批"),
                ...
                questions: [
                    SessionInterventionQuestion(
                        id: "demo_next_step",
                        header: "1.",
                        prompt: AppLocalization.string("是否批准 TRAE FLOW 继续完成这轮演示？"),
                        detail: AppLocalization.string("选择“批准并继续”，再点击提交，TRAE FLOW 会模拟处理完成并弹出通知。"),
                        options: [
    ...
    private static func demoClientInfo(sessionId: String) -> SessionClientInfo {
        SessionClientInfo(
            kind: .custom,
            profileID: "trae-flow-demo",
            name: "TRAE FLOW Demo",
            launchURL: "traeflow://demo/\(sessionId)",
            origin: "demo"
        )
    }
...
private struct HookWalkthroughDemoBackdropView: View {
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 8) {
                Text(appLocalized: "TRAE FLOW 演示模式")
